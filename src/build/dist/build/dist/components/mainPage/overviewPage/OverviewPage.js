...
var OverviewPage = function () {
    ...
    return (react_1.default.createElement(react_bootstrap_1.Container, null, react_1.default.createElement(OverviewPageStyled_1.default.MainContainer, null, react_1.default.createElement(react_bootstrap_1.Row, { xl: '12', lg: '10', md: '8', sm: '8', xs: "6" }, react_1.default.createElement(react_bootstrap_1.Col, { xl: '12', lg: '12', md: '12', sm: '12', xs: "12" }, react_1.default.createElement(OverviewPageStyled_1.default.MyTittle, null, paramsName.name), react_1.default.createElement(OverviewPageStyled_1.default.MyDiv, null, "Direct subordinates: " + employerDataSelector[0]))), react_1.default.createElement(react_bootstrap_1.Row, { xl: '12', lg: '10', md: '8', sm: '8', xs: "6" }, react_1.default.createElement(react_bootstrap_1.Col, { xl: '12', lg: '12', md: '12', sm: '12', xs: "12" }, react_1.default.createElement(OverviewPageStyled_1.default.MyUL, null, (employerDataSelector[1]) ? employerDataSelector[1]["direct-subordinates"].map(function (e, i) {
        return react_1.default.createElement(OverviewPageStyled_1.default.MyLI, { key: i }, e);
    }) : react_1.default.createElement("div", null, "Haven`t subordinates")))))));
};
exports.default = OverviewPage;
//# sourceMappingURL=OverviewPage.tsx.map
